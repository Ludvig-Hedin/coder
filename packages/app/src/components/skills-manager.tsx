    ...
    <div class="group flex h-full flex-col rounded-lg border border-border-weak-base bg-surface-base p-4 transition-colors hover:bg-surface-base-hover">
      <button type="button" class="flex flex-1 flex-col text-left" onClick={props.onOpen}>
        <div class="flex items-center gap-3">
          ...
          <div class="min-w-0">
            <div class="text-8-medium uppercase tracking-[0.16em] text-text-weaker">{props.category}</div>
      ...
      <div class="flex max-h-[78vh] flex-col gap-4 overflow-hidden p-3">
        <div class="flex flex-col gap-2 border-b border-border-weak-base px-2 pb-4 pt-2">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="min-w-0">
              <div class="text-8-medium uppercase tracking-[0.04em] text-text-weaker">{kind()}</div>
              <h2 class="pt-2 text-[28px] font-medium leading-[1.12] tracking-[-0.03em] text-text-strong">
                {item().name}
              </h2>
            </div>
            <div class="flex flex-wrap items-center gap-2">
              <span class="rounded-md border border-border-weak-base bg-surface-panel px-2.5 py-1 text-8-medium text-text-weak">
                {source()}
              </span>
              <Show when={added()}>
                <span class="rounded-md border border-border-weak-base bg-surface-panel px-2.5 py-1 text-8-medium text-text-weak">
