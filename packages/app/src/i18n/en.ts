export const dict = {
  ...
  "command.agent.toggleBuildPlan": "Toggle Build/Plan",
  "command.agent.toggleBuildPlan.description": "Switch between the Build and Plan agents",
  ...
  "prompt.autoaccept.label": "Auto accept",
  "prompt.reasoning.title": "Reasoning effort",
  "prompt.reasoning.description.low": "Fast responses with lighter reasoning",
  "prompt.reasoning.description.medium": "Balanced speed and reasoning depth",
  "prompt.reasoning.description.high": "More deliberate reasoning for harder tasks",
  "prompt.reasoning.description.xhigh": "Maximum reasoning depth with the slowest responses",
  ...
  "session.followupDock.delete": "Delete queued message",
